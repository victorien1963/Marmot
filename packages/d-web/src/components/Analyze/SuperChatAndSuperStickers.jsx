...
function SuperChatAndSuperStickers() {
  return (
    <div
    ...
    >
      <Row>
        <h4 className="text-start">Super Chat & Super Stickers</h4>
      </Row>
      <Row>
      ...
      <Row className="pt-4">
        <h4 className="text-start">Top Super Chat & Super Stickers</h4>
        <div className="px-3">
...
export default SuperChatAndSuperStickers
